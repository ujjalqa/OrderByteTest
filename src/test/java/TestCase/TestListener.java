...
{
//	private  ExtentReports extent1 = BaseClass.
...
//        extent.flush();
    ...
    public synchronized void onTestStart(ITestResult result) {
        ...
        ExtentTest extentTest = extent.createTest(result.getMethod().getDescription()).assignAuthor("Ujjal").assignCategory("Sanity");
        test.set(extentTest);
